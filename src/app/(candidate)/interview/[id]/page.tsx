...
import { CheckCircle2, XCircle, ArrowLeft, BrainCircuit, Code2, MessagesSquare, PlayCircle, RefreshCw } from 'lucide-react'
import Link from 'next/link'
import { Button } from '@/components/ui/button'
import { ReportPolling } from './report-polling'
import { retryReportAction } from '@/actions/interview'
      ...
      <div className="flex flex-col items-center justify-center min-h-[60vh] text-center px-4">
        ...
        {interview.status === 'PENDING' ? (
          ...
          <>
            ...
            <Link href="/dashboard" className="mt-6 text-sm text-muted-foreground hover:text-foreground underline underline-offset-4">
              Back to Dashboard
            </Link>
          </>
        ) : (
